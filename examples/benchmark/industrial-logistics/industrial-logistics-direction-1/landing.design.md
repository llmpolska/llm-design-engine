---
id: industrial-logistics-direction-1-design
route: /
concept: freight as a route through loads
status: draft
---

# Narrative

Freight enters as context, concentrates around synchronize, then resolves through an explicit next action. This direction gives freight the first move and loads the proof.

# Composition

## Freight entry

- id: industrial-logistics-entry-0
...
- id: industrial-logistics-action-0
- height: min(82svh, 760px)
- layout: anchored action surface
- focal-point: sequence
- alignment: start
- Make sequence the dominant transition
- Keep adjacent context visible

## Synchronize context

- id: industrial-logistics-context-0
- height: min(82svh, 760px)
...
- marked freight surfaces
- freight marks
- synchronize surfaces
- sequence traces
- keyword: freight as a route through loads
- keyword: route
...
<!-- lde-data
{
  ...
  "concept": "freight as a route through loads",
  "status": "draft",
  "directionId": "industrial-logistics-direction-1",
  "narrative": "Freight enters as context, concentrates around synchronize, then resolves through an explicit next action. This direction gives freight the first move and loads the proof.",
  "composition": {
    "sections": [
      {
        "id": "industrial-logistics-entry-0",
  ...
  "visualLanguage": {
    ...
    "keywords": [
      "freight as a route through loads",
      "route",
  ...
  "colors": {
    "background": "hsl(78 28% 12%)",
    "foreground": "hsl(79 28% 92%)",
    "accent": "hsl(119 28% 92%)",
    "muted": "hsl(80 28% 12%)",
    "secondary": "hsl(161 28% 92%)"
  },
  "responsive": {
    "mobile": [
  ...
  "scene": {
    ...
    "nodes": [
      {
        "id": "industrial-logistics-direction-1-field",
        "kind": "frame",
        "x": 0,
        "y": 0,
        "width": 1200,
      ...
      {
        "id": "industrial-logistics-direction-1-title",
        "kind": "text",
        "x": 72,
        "y": 76,
        "width": 630,
      ...
      {
        "id": "industrial-logistics-direction-1-metaphor",
        "kind": "text",
        "x": 72,
        "y": 210,
        "width": 480,
        "height": 72,
        "role": "metaphor",
        "text": "freight as a route through loads",
        "fontRole": "body",
        "size": 22,
        "weight": 400,
        "color": "hsl(79 28% 92%)"
      ...
      {
        "id": "industrial-logistics-direction-1-trace",
        "kind": "line",
        "x": 72,
        "y": 342,
        "width": 760,
      ...
      {
        "id": "industrial-logistics-entry-0-label",
        "kind": "text",
        "x": 96,
        "y": 412,
        "width": 560,
      ...
      {
        "id": "industrial-logistics-action-0-label",
        "kind": "text",
        "x": 134,
        "y": 518,
        "width": 560,
      ...
      {
        "id": "industrial-logistics-context-0-label",
        "kind": "text",
        "x": 96,
        "y": 624,
        "width": 560,
  ...
  "motion": {
    "principles": [
      "sequence changes the reading path",
  ...
  "agentInstructions": [
    "Keep the freight as a route through loads identity intact.",
    "Build the route opening before adding supporting details.",
    "Use freight, loads, synchronize, routes as domain-specific evidence.",
  ...
  "hypothesis": {
    "id": "industrial-logistics-hypothesis-1",
    "statement": "Freight becomes the visual behavior for Keep the route trustworthy when timing slips; loads proves each transition.",
    "visualMetaphor": "freight as a route through loads",
    "emotionalBehavior": "The interface moves from calm agency while sequence accelerates to a clear resolve.",
    "spatialStrategy": "a lateral route with one dominant turn",
    "focalStrategy": "Keep freight dominant; use loads as evidence rather than ornament.",
    "materialBehavior": "marked freight surfaces",
    "typographyBehavior": "Use typographic contrast to mark resolve and let freight set the reading pace.",
    "interactionBehavior": "resolve changes emphasis in place while preserving the original route.",
    "visualDirectionPrompt": "Sparse art-direction plate for industrial logistics: freight as a route through loads. Show marked freight surfaces, a lateral route with one dominant turn, one focal interface trace, and negative space. No finished website, no invented copy, no feature grid, no stock imagery, no named style references.",
    "evidence": [
      {
        "source": "domain",
        "input": "industrial logistics",
  ...
  "compositionPlan": {
    ...
    "sectionRelationships": [
      "industrial-logistics-entry-0 leads to industrial-logistics-action-0",
      "industrial-logistics-action-0 supports industrial-logistics-context-0"
    ],
    "overlapRules": [
  ...
  "sceneGraph": {
    ...
    "regions": [
      {
        ...
        "height": 76,
        "layerIds": [
          "industrial-logistics-entry-0-layer",
          "industrial-logistics-entry-0-label"
        ],
        "emphasis": 1,
        "responsive": {
      ...
      },
      {
        ...
        "height": 76,
        "layerIds": [
          "industrial-logistics-action-0-layer",
          "industrial-logistics-action-0-label"
        ],
        "emphasis": 0.84,
        "responsive": {
          "mobile": "stack after previous region",
      ...
      },
      {
        ...
        "height": 76,
        "layerIds": [
          "industrial-logistics-context-0-layer",
          "industrial-logistics-context-0-label"
        ],
    ...
    "layers": [
      {
        "id": "industrial-logistics-entry-0-industrial-logistics-entry-0-layer-layer",
        "nodeId": "industrial-logistics-entry-0-layer",
        "regionId": "industrial-logistics-entry-0",
        "zIndex": 0,
        "semanticRole": "surface",
        "anchor": "industrial-logistics-entry-0"
      },
      {
        "id": "industrial-logistics-entry-0-industrial-logistics-entry-0-label-layer",
        "nodeId": "industrial-logistics-entry-0-label",
        "regionId": "industrial-logistics-entry-0",
        "zIndex": 1,
        "semanticRole": "label",
        "anchor": "industrial-logistics-entry-0"
      ...
      {
        "id": "industrial-logistics-action-0-industrial-logistics-action-0-layer-layer",
        "nodeId": "industrial-logistics-action-0-layer",
        "regionId": "industrial-logistics-action-0",
        "zIndex": 0,
        "semanticRole": "surface",
        "anchor": "industrial-logistics-action-0"
      },
      {
        "id": "industrial-logistics-action-0-industrial-logistics-action-0-label-layer",
        "nodeId": "industrial-logistics-action-0-label",
        "regionId": "industrial-logistics-action-0",
        "zIndex": 1,
        "semanticRole": "label",
        "anchor": "industrial-logistics-action-0"
      ...
      {
        "id": "industrial-logistics-context-0-industrial-logistics-context-0-layer-layer",
        "nodeId": "industrial-logistics-context-0-layer",
        "regionId": "industrial-logistics-context-0",
        "zIndex": 0,
        "semanticRole": "surface",
        "anchor": "industrial-logistics-context-0"
      },
      {
        "id": "industrial-logistics-context-0-industrial-logistics-context-0-label-layer",
        "nodeId": "industrial-logistics-context-0-label",
        "regionId": "industrial-logistics-context-0",
        "zIndex": 1,
        "semanticRole": "label",
        "anchor": "industrial-logistics-context-0"
    ...
    "relationships": [
      {
        "from": "industrial-logistics-entry-0",
        "to": "industrial-logistics-action-0",
        "kind": "leads-to",
        "rationale": "industrial-logistics-entry-0 leads to industrial-logistics-action-0"
      },
      {
        "from": "industrial-logistics-action-0",
        "to": "industrial-logistics-context-0",
        "kind": "leads-to",
        "rationale": "industrial-logistics-action-0 supports industrial-logistics-context-0"
      }
    ],
    "responsive": [
      {
