...
const brief: ProjectBrief = {
  id: 'gastroops', slug: 'gastroops', name: 'GastroOps', summary: 'Restaurant operations for busy teams', domain: 'restaurant operations',
  users: ['kitchen leads'], jobs: ['coordinate service'], tension: 'Keep control when service accelerates', constraints: [], references: [], createdAt: '2026-01-01T00:00:00.000Z', updatedAt: '2026-01-01T00:00:00.000Z',
};
...
describe('MockReasoningProvider', () => {
  ...
  it('refines without replacing the direction identity', async () => {
    ...
    const refined = await provider.refineDesign(design, 'Make the first read calmer and more tactile.');
